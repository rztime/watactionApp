...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/rztime/witactionApp"
  ...
  s.subspec 'Resource' do |ss|
    ss.resources = "CommonTools4iOS/Core/Resource/*"
  end
  ...
  s.subspec 'Tools' do |ss|
    ...
    ss.subspec 'RZRootManager' do |sss|
      ...
      sss.subspec 'Resource' do |ssss|
        ssss.resources =  'CommonTools4iOS/Core/Tools/RZRootManager/Resource/*'
      end
    end
    ...
    ss.subspec 'RZCarNoInputManage' do |sss|
      ...
      sss.subspec 'Resource' do |ssss|
        ssss.resources = 'CommonTools4iOS/Core/Tools/RZCarNoInputManage/RZCarPlateNumberKeyBorder/Resource/*'
      end
    end
    ...
    ss.subspec 'AppVersionManager' do |sss|
      ...
      sss.subspec 'Resource' do |ssss|
        ssss.resources = 'CommonTools4iOS/Core/Tools/AppVersionManager/AppVersion.bundle'
      end
    end
    ...
    ss.subspec 'RZHud' do |sss|
      ...
      sss.subspec 'Resource' do |ssss|
        ssss.resources = 'CommonTools4iOS/Core/Tools/RZHud/RZHud.bundle'
      end
    end
    ...
    ss.subspec 'RZFileManager' do |sss|
      ...
      sss.subspec 'Resource' do |ssss|
        ssss.resources = 'CommonTools4iOS/Core/Tools/RZFileManager/RZFileImage/RZFileImage.bundle'
      end
    end
