Pod::Spec.new do |s|
  ...
  s.subspec 'Tools' do |ss|
    ss.subspec 'RZCalendarView' do |sss|
      sss.dependency 'FSCalendar'
      sss.dependency 'ControllerManager'
      sss.dependency 'DefaultConfigure'
      sss.dependency 'Masonry'
      sss.dependency 'BlocksKit'
      sss.dependency 'Category'
      sss.dependency 'PGPickerView'
    end 
  	ss.subspec 'RZPickerView' do |sss|
      sss.source_files = 'CommonTools4iOS/Core/Tools/RZPickerView/*.{h,m}'
