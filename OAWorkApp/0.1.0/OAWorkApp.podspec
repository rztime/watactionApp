...
Pod::Spec.new do |s|
  ...
  s.source       = { :svn => "svn://huangkun@svn.witaction.com/EntCMCS/zxoa/thunk/ios/OAWorkApp" } #  :tag => "#{s.version}"
  ...
  s.source_files  = "OAApp", "OAWorkApp/OAApp/**/*.{h,m}"
  s.resources = "OAWorkApp/OAApp/**/*.{bundle}"
